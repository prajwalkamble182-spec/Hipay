...
async def button_click(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == 'video_reg':
        ...
        rewards_caption = "🎁 **HIPAY EXCLUSIVE REWARDS** 🎁\n\n💰 1st Wallet Bind: ₹100\n🔥 Up to 6 Wallets: ₹600"
        await query.message.reply_photo(photo=REWARDS_PHOTO_ID, caption=rewards_caption, reply_markup=InlineKeyboardMarkup(back_button))
    elif query.data == 'contact_manager':
        context.user_data['waiting_for_support'] = True
        await query.message.reply_text("✍️ **Support Mode Active:** Apna sawal yahan likhein.")
